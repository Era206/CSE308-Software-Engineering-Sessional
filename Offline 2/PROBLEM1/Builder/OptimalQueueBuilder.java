...
import PROBLEM1.component.ArduinoMega;
import PROBLEM1.component.Display;
import PROBLEM1.component.LED;
import PROBLEM1.component.Processors;


public class OptimalQueueBuilder extends QueueBuilder{
    Queue queue=new Queue();

    public OptimalQueueBuilder(Queue queue) {
        this.queue = queue;
    }

    @Override
    public void setProcessorNew() {
        Processors p = new ArduinoMega();
